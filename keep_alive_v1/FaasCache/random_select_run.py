...
def load_trace(num_functions, char):
    pth = "/Users/xieshuaiyu/experiment/faascache-sim/data2/trace_pckl/precombined/{}-{}.pckl".format(num_functions, char)
...
def compare_pols(policy, num_functions, char, mem_capacity=32000):
    ...
    save_pth = "/Users/xieshuaiyu/experiment/faascache-sim/data2/random_trace_runs"
