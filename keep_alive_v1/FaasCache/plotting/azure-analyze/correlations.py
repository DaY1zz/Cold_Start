...
dur_pth = "/Users/xieshuaiyu/experiment/faascache-sim/data2/function_durations_percentiles.anon.d01.csv"

invoc_pth = "/Users/xieshuaiyu/experiment/faascache-sim/data2/invocations_per_function_md.anon.d01.csv"
buckets = [str(i) for i in range(1, 1441)]
columns = ["HashOwner","HashApp","HashFunction","Trigger"] + buckets

mem_pth = "/Users/xieshuaiyu/experiment/faascache-sim/data2/app_memory_percentiles.anon.d01.csv"
