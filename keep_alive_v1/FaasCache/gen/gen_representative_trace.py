...
import sys
sys.path.insert(1, '/Users/xieshuaiyu/experiment/faascache-sim/code/split/')
from LambdaData import *
import pickle
from math import ceil

save_dir = "/Users/xieshuaiyu/experiment/faascache-sim/data2/trace_pckl/represent/"
store = "/Users/xieshuaiyu/experiment/faascache-sim/data2/trace_pckl/"
buckets = [str(i) for i in range(1, 1441)]

datapath = "/Users/xieshuaiyu/experiment/faascache-sim/data2/"
...
def convert_to_two_hour(path):
    ...
    save_pth = "{}-{}.pckl".format(num_funcs, run)
    save_dir = "/Users/xieshuaiyu/experiment/faascache-sim/data2/trace_pckl/represent_two_hour/"
    save_pth = os.path.join(save_dir, save_pth)
