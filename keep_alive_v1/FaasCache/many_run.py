...
def compare_pols(policy, num_functions, char, mem_capacity=32000, args=None):
    # save_pth = "/Users/xieshuaiyu/experiment/faascache-sim/data2/alfuerst/verify-test/"
    # log_dir = "/Users/xieshuaiyu/experiment/faascache-sim/data2/alfuerst/verify-test/logs/"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--tracedir", type=str, default="/Users/xieshuaiyu/experiment/faascache-sim/data2/trace_pckl/represent/", required=False)
    parser.add_argument("--numfuncs", type=int, default=392, required=False)
    parser.add_argument("--savedir", type=str, default="/Users/xieshuaiyu/experiment/faascache-sim/data2/alfuerst/verify-test/", required=False)
    parser.add_argument("--logdir", type=str, default="/Users/xieshuaiyu/experiment/faascache-sim/data2/alfuerst/verify-test/logs/", required=False)
